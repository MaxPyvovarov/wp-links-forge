...
<?php get_header();?>
		...
		<main>
			<section id="hero">
				<div class="container relative">
					<div class="hero-content fade-in">
						<h1><?php the_field('UA-reviews-hero-h1'); ?></h1>
						<p><?php the_field('UA-reviews-hero-h2'); ?></p>
						<a href="#prices" class="btn-primary">Замовити посилання</a>
					</div>
					<img
						class="hero-main-img reviews fade-in"
						src="<?php bloginfo('template_url');?>/assets/images/services/reviews/hero-main.svg"
						alt=""
					/>
					<img
						class="hero-bg-img reviews"
						src="<?php bloginfo('template_url');?>/assets/images/services/reviews/hero-bg.svg"
						alt=""
					/>
				</div>
			</section>
				...
				<div class="container">
					<div class="advantages-content">
						<div class="advantages-text fade-in fade-in-left">
							<h2 class="blue"><?php the_field('UA-reviews-advantages-h1'); ?></h2>
							<p><?php the_field('UA-reviews-advantages-h2'); ?></p>
						</div>
						<img
							class="advantages-img reviews fade-in fade-in-right"
							src="<?php the_field('UA-reviews-advantages-img'); ?>"
							alt=""
						/>
					</div>
				</div>
			...
			<section id="why-us">
				<div class="container relative">
					<h2 class="blue fade-in">
						<?php the_field('UA-reviews-whyus-h1'); ?>
					</h2>
					<div class="why-us-content">
						<?php
							$block = get_field('UA-reviews-whyus-block1');
							if( $block ): ?>
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-reviews-whyus-block2');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-reviews-whyus-block3');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-reviews-whyus-block4');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-reviews-whyus-block5');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
			...
			<section id="countries">
				<div class="container relative">
					<h2 class="fade-in"><?php the_field('UA-reviews-countries-h1'); ?></h2>
				...
				<div class="container">
					<div class="impact-content">
						<div class="impact-text fade-in fade-in-left">
							<h2 class="blue"><?php the_field('UA-reviews-impact-h1'); ?></h2>
							<p><?php the_field('UA-reviews-impact-text'); ?></p>
						</div>
						<img
							src="<?php the_field('UA-reviews-impact-img'); ?>"
			...
			<section id="prices">
				<div class="container">
					<h2 class="fade-in"><?php the_field('UA-reviews-prices-h1'); ?></h2>
					<div class="prices-list">
						<div class="row">
							<?php
							$block = get_field('UA-reviews-prices-item1');
							if( $block ): ?>
							...
							<?php endif; ?>
							<?php
							$block = get_field('UA-reviews-prices-item2');
							if( $block ): ?>
								<div class="prices-item relative fade-in">
									<div class="content">
										<h3 class="blue"><?php echo $block['title']; ?></h3>
						...
						<div class="row">
							<?php
							$block = get_field('UA-reviews-prices-item3');
							if( $block ): ?>
								<div class="prices-item relative fade-in">
									<div class="content">
										<h3 class="blue"><?php echo $block['title']; ?></h3>
						...
						<?php endif; ?>
							<div class="prices-item special fade-in">
								<div class="content">
									<h3 class="blue"><?php the_field('UA-reviews-special-h1'); ?></h3>
									<p class="subheading"><?php the_field('UA-reviews-special-h2'); ?></p>
									<img
										src="<?php bloginfo('template_url');?>/assets/images/services/special-offer.svg"
										alt=""
									/>
									<p class="caption"><?php the_field('UA-reviews-special-h1'); ?></p>
								</div>
								<button
									data-selected-plan="<?php echo $block['title']; ?>"
									data-open-modal
				...
				<div class="container">
					<div class="feedback-content">
						<div class="feedback-left fade-in fade-in-left">
							<h2 class="blue"><?php the_field('UA-reviews-feedback-h1'); ?></h2>
