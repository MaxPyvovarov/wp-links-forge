...
<?php get_header();?>
		...
		<main>
			<section id="hero">
				<div class="container relative">
					<div class="hero-content fade-in">
						<h1><?php the_field('UA-submits-hero-h1'); ?></h1>
						<p><?php the_field('UA-submits-hero-h2'); ?></p>
				...
				<div class="container">
					<div class="advantages-content">
						<div class="advantages-text fade-in fade-in-left">
							<h2 class="blue"><?php the_field('UA-submits-advantages-h1'); ?></h2>
							<p><?php the_field('UA-submits-advantages-h2'); ?></p>
						</div>
						<img
							class="advantages-img submits fade-in fade-in-right"
							src="<?php the_field('UA-submits-advantages-img'); ?>"
							alt=""
						/>
					</div>
				</div>
			...
			<section id="why-us">
				<div class="container relative">
					<h2 class="blue fade-in">
						<?php the_field('UA-submits-whyus-h1'); ?>
					</h2>
					<div class="why-us-content">
						<?php
							$block = get_field('UA-submits-whyus-block1');
							if( $block ): ?>
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-submits-whyus-block2');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-submits-whyus-block3');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-submits-whyus-block4');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
						...
						<?php endif; ?>
						<?php
							$block = get_field('UA-submits-whyus-block5');
							if( $block ): ?>
							<div class="reason fade-in">
								<div class="reason-heading">
									<img
			...
			<section id="countries">
				<div class="container relative">
					<h2 class="fade-in"><?php the_field('UA-submits-countries-h1'); ?></h2>
				...
				<div class="container">
					<div class="impact-content">
						<div class="impact-text fade-in fade-in-left">
							<h2 class="blue"><?php the_field('UA-submits-impact-h1'); ?></h2>
							<p><?php the_field('UA-submits-impact-text'); ?></p>
						</div>
						<img
							src="<?php the_field('UA-submits-impact-img'); ?>"
			...
			<section id="prices">
				<div class="container">
					<h2 class="fade-in"><?php the_field('UA-submits-prices-h1'); ?></h2>
					<div class="prices-list">
						<div class="row">
							<?php
							$block = get_field('UA-submits-prices-item1');
							if( $block ): ?>
							...
							<?php endif; ?>
							<?php
							$block = get_field('UA-submits-prices-item2');
							if( $block ): ?>
								<div class="prices-item relative fade-in">
									<div class="content">
										<h3 class="blue"><?php echo $block['title']; ?></h3>
						...
						<div class="row">
							<?php
							$block = get_field('UA-submits-prices-item3');
							if( $block ): ?>
								<div class="prices-item relative fade-in">
									<div class="content">
										<h3 class="blue"><?php echo $block['title']; ?></h3>
						...
						<?php endif; ?>
							<div class="prices-item special fade-in">
								<div class="content">
									<h3 class="blue"><?php the_field('UA-submits-special-h1'); ?></h3>
									<p class="subheading"><?php the_field('UA-submits-special-h2'); ?></p>
									<img
										src="<?php bloginfo('template_url');?>/assets/images/services/special-offer.svg"
										alt=""
									/>
									<p class="caption"><?php the_field('UA-submits-special-h1'); ?></p>
								</div>
								<button
									data-selected-plan="<?php echo $block['title']; ?>"
									data-open-modal
				...
				<div class="container">
					<div class="feedback-content">
						<div class="feedback-left fade-in fade-in-left">
							<h2 class="blue"><?php the_field('UA-submits-feedback-h1'); ?></h2>
