		...
		<main>
			<section id="faq">
				<div class="container relative">
					<h2 class="blue fade-in"><?php the_field('RU-faq-h1'); ?></h2>
					<div class="faq-content">
						<div class="questions fade-in fade-in-left">
							<?php
							$question = get_field('RU-faq-question1');
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question2');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question3');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question4');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question5');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question6');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question7');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question8');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question9');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question10');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question11');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question12');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question13');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question14');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
							...
							<?php endif; ?>
							<?php
							$question = get_field('RU-faq-question15');
							if( $question['question'] && $question['answer'] ): ?>
								<div class="question-wrapper">
									<div class="question">
										<h4><?php echo $question['question'];?></h4>
